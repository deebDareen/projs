...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        R_chart2  = dcc.Graph(figure=px.bar(average_sales, x = "Vehicle_Type", title = "Vehicle's sold by vehicle type"))
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        R_chart4 = dcc.Graph(
             figure = px.bar(data , "Vehicle_Type", "unemployment rate", title ="the effect of unemployment rate on vehicle type and sales")
        )
...
# Plot 2 Total Monthly Automobile sales using line chart.
        ...
        Y_chart2 = dcc.Graph(figure = px.line(mas, x = "Month", y = "Automobile_Sales", title ="Total Monthly Automobile sales using line chart" ))

            # Plot bar chart for average number of vehicles sold during the given year
        avr_vdata=yearly_data.groupby("Year")['Automobile_Sales'].mean().reset_index()
        Y_chart3 = dcc.Graph( figure= px.bar(avr_data, x = "Year", title='Average Vehicles Sold by Vehicle Type in the year {}'.format(input_year)))
